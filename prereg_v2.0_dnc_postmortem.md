...
| 2026-05-24 | **§10 dev 6: H5 outcomes REVISED to 2 items (well-attested batteries).** With §10 dev 2-5 dropping 4 of 5 originally-pre-reg'd H5 items, the H5 outcome set is revised to: **(a)** CES structural_inequity = first principal component of CC24_441_grid 4-item racial resentment battery ("Irish/Italians worked their way up" / "generations of slavery created difficulty" / "blacks gotten less than they deserve" / "if blacks tried harder" — z-scored, reverse-coded so higher = lower racial resentment endorsement); **(b)** ANES racial_resentment = first principal component of V242300-V242303 4-item battery (same conceptual content, ANES wording, POST-election). | The two batteries are the canonical 4-item Kinder-Sanders racial resentment scale, well-established in the literature with documented psychometric properties. They are NOT a like-for-like substitute for the 4 dropped items, but they are the strongest cohort-stratifiable racial-attitudes outcome available cross-substrate in 2024. Cross-substrate replication of cohort-loading on this battery is now the H5 test. Pre-reg aggregate gate ("≥3 of 5 cohort-dominant") becomes "1 of 2 cohort-dominant cross-substrate" — verdict scale reset to: BOTH-COHORT-DOMINANT / ONE-COHORT-DOMINANT / NEITHER. |
